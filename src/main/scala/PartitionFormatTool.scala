...
object PartitionFormatTool {
  ...
  /** Normaliza un partitionSpec en modo KV (key=value), inyectando executionDate y limpiando comodines. */
  ...
  /** Extracts an ISO date if present, otherwise returns defaultISO. */
